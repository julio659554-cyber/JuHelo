const CACHE='juhelo-v33';
const CORE=['./','./index.html','./app-v31.css?v=33','./app-v31.js?v=33','./boot-v33.js?v=33','./supabase-proxy-v33.js?v=33','./manifest.webmanifest?v=33','./assets/icon.svg'];
